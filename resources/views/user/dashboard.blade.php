                                ...
                                <tbody>
                                    @if ($team_member_list->count())
                                        ...
                                        <tr>
                                            ...
                                            @if (array_key_exists($this_member->id ,$team_member_total_urls))
                                                <td>{{ $team_member_total_urls[$this_member->id] }}</td>
                                            @else
                                                <td>0</td>
                                            @endif
                                            @if (array_key_exists($this_member->id ,$team_member_url_hits))
                                                <td>{{ $team_member_url_hits[$this_member->id] }}</td>
                                            @else
                                                <td>0</td>
                                            @endif
                                        </tr> 
